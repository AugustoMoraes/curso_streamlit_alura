...
aba1, aba2, aba3 = st.tabs(['Receita', 'Quatidade de vendas', 'Vendedores'])
...
with aba3:
    ...
    with coluna1:
        ...
        fig_receita_vendedores = px.bar(vendedores[['sum']].sort_values('sum', ascending=False).head(qtd_vendedores),
                                        ...
                                        text_auto=True,
                                        title= f'Tp {qtd_vendedores} vendedores (receita)')
    ...
    with coluna2:
        ...
        fig_venda_vendedores = px.bar(vendedores[['count']].sort_values('count', ascending=False).head(qtd_vendedores),
                                        ...
                                        text_auto=True,
                                        title= f'Tp {qtd_vendedores} vendedores (quantidade de vendas)')
